...
## Marketing and sharing handoff

- [Marketing feature spec and creative brief](docs/marketing-feature-spec.md) — audience, feature benefits, campaign directions, copy deliverables, and claim boundaries.
- [Sharing implementation spec](docs/sharing-spec.md) — share behavior, preview coverage, verification, and rollout checks.
- Run `node scripts/sharing-smoke.mjs` against a running app to verify crawler metadata and PNG previews; see the spec for optional public fixture IDs.
